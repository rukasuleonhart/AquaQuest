...
export default function Perfil() {
  ...
  const editableFields: (keyof Profile)[] = ['name', 'weight_kg', 'activity_time', 'ambient_temp_c'];
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValue}>{profile.activity_time} minutos</Text>
            </View>
            <View style={styles.statBox}>
